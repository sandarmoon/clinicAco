...
function getPieView(result,net){
    ...
    $(document).ready(function(){
	    ...
	    $('.endDate-title').html(endDay);
	     ...
	     getReport(firstDay,endDay,"expense");
	      ...
	      function getReport(sdate,edate,name){
		      // ajax start
		          $.ajax({
		            url:"<?php echo e(route('getexpenseReport')); ?>",
		            type:'POST',
	    ...
	    $('#expenseCategory').change(function(){
		    ...
		    var url="<?php echo e(route('filterExpensbyCategory')); ?>";
      // url=url.replace(':cid',categoryid);
	    ...
	    $('.print-income').click(function(){
	    	var start=$('.startDate-title').html();
		    var end=$('.endDate-title').html();
		    var url="<?php echo e(route('printIncomeListpdf')); ?>";
		    $.ajax({
		    	 url: url,
	            type: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/expense/transactionReport.blade.php ENDPATH**/ ?>