...
@section('content')
	<div class="card">
      <div class="container">
                      	<h2  class="mt-3">Update Patient  Information for <span class="text-danger">PRN no.{{$patient->PRN}}</span></h2>
                      	<form class="p-2" method="post" action="{{route('patient.update',$patient->id)}}" enctype="multipart/form-data">
                      		@csrf
                          @method('PUT')
