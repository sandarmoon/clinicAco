	            		...
	            		<div id="search">
						  ...
						  <!-- 	<div class="col-xl-4 col-lg-4 d-xl-inline-flex order-xl-1 order-lg-1 mb-lg-3">
						    ...
						    <div class="col-xl-3 col-lg-3 order-xl-4 order-lg-4 d-xl-inline-flex mt-xl-0 mt-lg-5 mt-md-5 mt-sm-3 mt-xs-3 mt-3 ">
						    	...
						    	<form id="export-form" action="<?php echo e(route('exportExcel')); ?>" method="post" >
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/expense/report.blade.php ENDPATH**/ ?>