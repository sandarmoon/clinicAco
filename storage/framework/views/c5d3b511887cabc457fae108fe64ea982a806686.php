            ...
            <div class="card bg-secondary shadow">
              <div class="card-header bg-white border-0">
                <div class="row align-items-center">
                  ...
                  <img src="<?php echo e(asset($doctor->avatar)); ?>" width="60" class="rounded-circle float-left d-inline-block mr-4 mt-3">
                      
                    <h3 class=" p-0 pr-4 mt-3 "><?php echo e($doctor->user->name); ?></h3>
                     <h6 class="small text-muted mb-4">Position:  <?php echo e($doctor->user->roles[0]->name); ?></h6>
                  </div>
                  <?php if(auth()->check() && auth()->user()->hasRole('Admin|Doctor')): ?>
                  <div class="col-4 text-right">
                    <a href="<?php echo e(route('doctor.edit',$doctor->id)); ?>" class="btn btn-sm btn-primary">Edit Profile</a>
                  </div>
                  <?php endif; ?>
                </div>
              </div>
                  ...
                  <div class="col-xl-7 col-lg-7 col-md-6 col-sm-6 col-xs-6 col-6 ">
                    ...
                    <div class="row  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0" >
                      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        <p class="description mb-0 ">Email:</p>
                                  <h5 class="heading-my ml-3 " style="transform: none;"><?php echo e($doctor->user->email); ?></h5>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                    ...
                    <div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
                      <div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        <p class="description mb-0 ">Name:</p>
                                  <h5 class="heading-my ml-3 " style="transform: none;"><?php echo e($doctor->user->name); ?></h5>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        <p class="description mb-0 ">NRC NO:</p>
                                  <h5 class="heading-my ml-3 " style="transform: none;"><?php echo e($doctor->nrc); ?></h5>
                              </div>
                    </div>
                    <div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
                      <div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                    ...
                    <!-- <div class="row  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0" >
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        ...
                        <p class="description mb-0 d-flex ">Logo:<img src="<?php echo e(asset('template/assets/img/theme/team-4-800x800.jpg')); ?>" width="40" class="rounded-circle  d-inline-block ml-3"></p>
                    ...
                    <div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
                      <div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        <p class="description mb-0 ">Phone:</p>
                                  <h5 class="heading-my ml-3 " style="transform: none;"><?php echo e($doctor->phone); ?></h5>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        <p class="description mb-0 ">Address:</p>
                                  <h5 class="heading-my ml-3 " style="transform: none;"><?php echo e($doctor->address==null? "not added!":$doctor->address); ?></h5>
                              </div>
                    </div>
                    <!-- <div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
                      <div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                  ...
                  <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-xs-6 col-6 ">
                    ...
                    <div class="row  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0" >
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        <p class="description mb-0 ">Degree:</p>
                                <h5 class="heading-my ml-3 " style="transform: none;"><?php echo e($doctor->degree); ?></h5>
                    </div>
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        ...
                        <div id="preview-certificate"  data-img=<?php echo e($doctor->certificate); ?>><span class="description">Certificate:</span>
                    ...
                    <div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
                      <div class="col-xl-12 col-lg-12  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
                        ...
                        <div id="preview-license" class="mt-4" data-img=<?php echo e($doctor->license); ?>><span class="description">License:</span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/doctor/detail.blade.php ENDPATH**/ ?>