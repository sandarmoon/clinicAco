         ...
         <div class="row justify-content-center">
            <div class="col-lg-3 order-lg-2">
               <div class="card-profile-image">
                  <a href="#">
                  <img src="<?php echo e(asset($r_user->file)); ?>" class="rounded-circle">
                  </a>
               </div>
            </div>
         </div>
            ...
            <div class="">
               <div class="col-12">
                  <div class="card-profile-stats justify-content-center  mt-md-5">
                     <p>Name : <b><?php echo e($r_user->user->name); ?></b></p>
                     <p>clinic  : <b><?php echo e($r_user->owner->clinic_name); ?></b></p>
                     <p>Phone : <b><?php echo e($r_user->phoneno); ?></b></p>
                     <p>Email : <b><?php echo e($r_user->user->email); ?></b></p>
                  </div>
               </div>
            </div>
         </div>
