    ...
    <div class="card">
      ...
      <div class="card-header">
        ...
        <h3>Create A New Patient 
          <a href="<?php echo e(route('patient.index')); ?>"  style="padding-left:800px"><i class="fas fa-backward"></i> back</a>
        </h3>
      </div>
...
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/patients/create.blade.php ENDPATH**/ ?>