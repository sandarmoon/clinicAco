	            ...
	            <div class="card-header bg-white border-0">
	              <div class="row align-items-center">
	                <div class="col-8">
		               ...
		               @if( ($reception->file!=null) )
		              <img src="{{asset($reception->file)}}" width="60" class="rounded-circle float-left d-inline-block mr-4 mt-3 ">
		              @endif
		                  
	                  <h3 class=" p-0 pr-4 mt-3 ">{{$reception->user->name}}</h3>
	                   <h6 class="small text-muted mb-4">Role:{{$reception->user->roles[0]->name}} of {{$reception->owner->clinic_name}}</h6>
	                </div>
	            			...
	            			<div class="row  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0" >
		            			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
		            				<p class="description mb-0 ">Name:</p>
		                              <h5 class="heading-my ml-3 " style="transform: none;">{{$reception->user->name}}</h5>
		            			</div>
		            			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">

		            				<p class="description mb-0 d-flex ">Gender:</p>
		            				<h5 class="heading-my ml-3 my-td " style="transform: none;">{{$reception->gender}}</h5>
		            		...
		            		<div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
		            			<div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
		            				<p class="description mb-0 ">Phone:</p>
		                              <h5 class="heading-my ml-3 " style="transform: none;">{{$reception->phoneno}}</h5>
		            			</div>
		            			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
		            				<p class="description mb-0 ">Address:</p>
		                              <h5 class="heading-my ml-3 " style="transform: none;">{{$reception->address}}</h5>
	                          	</div>
		            		</div>
		            		<!-- <div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
		            			<div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
	            			...
	            			<div class="row  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0" >
		            			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
		            				<p class="description mb-0 ">Email:</p>
		                              <h5 class="heading-my ml-3 " style="transform: none;">{{$reception->user->email}}</h5>
		            			</div>
		            		...
		            		<div class="row mt-3  p-lg-2 p-md-2 p-sm-0 p-sx-0 p-0">
		            			<div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
		            				<p class="description mb-0 d-inline-block ">Degree:</p>
		                              <h5 class="heading-my ml-3 " style="transform: none;">{{$reception->education}}</h5>
		            			</div>
		            			<!-- <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 mt-lg-0 mt-md-3 mt-sm-3 mt-xs-3 mt-3">
