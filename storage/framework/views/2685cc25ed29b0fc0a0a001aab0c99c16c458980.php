<?php $__env->startSection('content'); ?>
	<div class="card">
      <div class="container">
                      	<h2  class="mt-3">Update Patient  Information for <span class="text-danger">PRN no.<?php echo e($patient->PRN); ?></span></h2>
                      	<form class="p-2" method="post" action="<?php echo e(route('patient.update',$patient->id)); ?>" enctype="multipart/form-data">
                      		<?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/patients/edit.blade.php ENDPATH**/ ?>