                     ...
                     <!--  <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                          <div class="card-profile-image">
                            <a href="#">
                              <img src="{{asset('template/assets/img/theme/team-4-800x800.jpg')}}" class="rounded-circle">
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card-body pt-0 pt-md-4">
                        <div class="text-center" style="margin-top: 1rem;">
                            <img style="max-width: 110px;" src="{{asset('template/assets/img/theme/team-4-800x800.jpg')}}" class="rounded-circle">
                        </div>
                        <h2 class="text-center mt-5 mb-0">{{$patientinfo->patient->name}}</h2>
                        <h4 class="text-center text-muted m-0"></h4>
                          <div class="row">
                            <div class="col">
                              <div class="card-profile-stats d-flex justify-content-center">
                                <div>
                                  <span class="heading">{{count($treatments)}}</span>
                                  <span class="description">Visit time</span>
                                </div>
                                <div>
                                  <span class="heading">{{count($chargeDoctor)}}</span>
                            ...
                            <div class="col py-0 my-0">
                              <div class="card-profile-stats d-flex justify-content-around my-0 py-0">
                                <div class="p-0">
                                  ...
                                  <span class="heading ">{{$patientinfo->patient->gender}}</span>
                                </div>

                                <div class="p-0">
                                  <span class="description ">Age</span>
                                  <span class="heading ">{{$patientinfo->patient->age}}</span>
                                </div>

                                <div class="p-0">
                                  <span class="description ">Family Member</span>
                                  <span class="heading ">{{$patientinfo->patient->fatherName}}</span>
                                </div>
                            ...
                            <div class="col py-0 my-0">
                              <div class="card-profile-stats d-flex justify-content-around my-0 py-0">
                                <div class="p-0">
                                  ...
                                  <span class="heading my-td">{{$patientinfo->patient->address}}</span>
                                </div>

                                <div class="p-0">
                                  <span class="description">Phone</span>
                                  <span class="heading">{{$patientinfo->patient->phoneno}}</span>
                                </div>

                                <div class="p-0">
                                  <span class="description">Registered Date</span>
                                  <span class="heading">{{Carbon\Carbon::parse($patientinfo->patient->created_at)->toFormattedDateString()}}</span>
                                </div>
                            ...
                            <div class="col pb-0 mb-0">
                              <div class="card-profile-stats d-flex justify-content-left my-0 py-0">
                                <div class="pr-5 ml-4 py-0">
                                  ...
                                  <span class="heading">{{$patientinfo->patient->job}}</span>
                                </div>
                                      ...
                                      <div class="med card col-sm-12 shadow" style="border-radius: 0px;">
                                        <div class="card-body pt-4">
                                          <div class="row">
                                              <div class="col-md-6 px-0">
                                                <div class="d-flex justify-content-lg-around">
                                                    <div>
                                                      ...
                                                      <span class="text-muted" >{{$record_time}}</span >
                                                    </div>
                                                    <span class="vl" 
                                                  style="display:inline-block;border-left: 1px solid #ccc; margin: 25px 0px; height: 30px;"></span>
                                                    <div class="mt-2"><p class="pb-0 mb-0 myfont">Doctor</p><p>{{$record->doctor->user->name}}</p></div>
                                                  <span class="vl" 
                                                  style="display:inline-block;border-left: 1px solid #ccc; margin: 25px 0px; height: 30px;"></span>  
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-md-6">
                                                <div class="d-flex justify-content-lg-around">
                                                    <div class="mt-2"><p class="pb-0 mb-0 ">GC-Level</p><p>{{$record->gc_level== null ? 'no record':$record->gc_level}}</p></div>
                                                    <div class="mt-2"><p class="pb-0 mb-0 ">Weight</p><p>{{$record->body_weight== null ? 'no record':$record->body_weight}}</p></div>
                                                    <div class="mt-2"><p class="pb-0 mb-0 ">Temperature</p><p>{{$record->temperature== null ? 'no record':$record->temperature}}</p></div>
 ...
 $(document).ready(function(){
  $('.dot-list li').click(function(){
    ...
    var pid=$(this).data('patientid');
      location.href="{{URL('patientRecordD')}}"+"/"+did+"/"+pid;
  })
 })
</script>
@endsection
