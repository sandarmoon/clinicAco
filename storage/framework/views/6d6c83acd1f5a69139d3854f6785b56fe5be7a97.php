<?php $__env->startSection('content'); ?>
  ...
  <div class="row card-deck">
    <div class="col-12">
      ...
      <div class="card col-xl-4 order-xl-2 mb-5 mb-xl-0" id="AddMedicine">
        <!-- Card header -->
      ...
      <div class="card col-xl-4 order-xl-2 mb-5 mb-xl-0" id="EditMedicine">
        <!-- Card header -->
        <div class="card-header border-0">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/medicine/index.blade.php ENDPATH**/ ?>