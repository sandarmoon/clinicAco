...
@endsection
@section('content')
  <div class=" h-100 container-fluid mt--7 d-xl-block d-lg-block d-md-none d-sm-none d-xs-none d-none ">
      <div class="row h-100 ">
        <!-- <div class=" col-xl-8 col-lg-8 showingcard  mb-5 mb-xl-0  "> -->
          <div class="card  shadow col-xl-8 col-lg-8 showingcard  mb-5  mb-xl-0">
                   ...
                   <!-- from start -->
                    ...
                    <!-- data showing -->
                       <div class="row px-3">
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 col-12 row justify-content-around">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 col-12 text-lg-right text-md-right text-sm-right text-xs-center text-center">
        ...
        <!-- <div class=" col-xl-4 col-lg-4 showingcard  "> -->
          <div class="card   bg-gradient-muted shadow col-xl-4 col-lg-4 showingcard ">
            <div class="card-header border-0 pb-0">
