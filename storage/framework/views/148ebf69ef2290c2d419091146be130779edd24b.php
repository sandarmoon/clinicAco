<?php $__env->startSection('content'); ?>
  ...
  <div class=" ">
      <div class="row pr-2 mb-2 card-deck">
        <!-- <div class=""> -->
          <div class="card card-profile shadow col-xl-4 order-xl-2 mb-5 mb-xl-0 p-3 bg-secondary CR" >
            
            <form id="AddMedicineType" class="mt-3">
			...
			<!-- Add form end -->
			<!-- Update form start -->
			<form id="EditMedicineType" class="">
        ...
        <!-- <div class="col-xl-8 order-xl-1"> -->
          ...
          <div class="card bg-secondary shadow col-xl-8 order-xl-1">
	          ...
	          "columns":[
	              ...
	              { "data":function(data){
	                  return `<button class="btn btn-primary btn-sm d-inline-block btnEdit "  data-id="${data.id}" data-name="${data.name}"><i class="ni ni-settings"></i></button>
	                            <button class="btn btn-danger btn-sm d-inline-block btnDelete " data-id="${data.id}" data-name="${data.name}"> <i class="ni ni-fat-delete"></i></button>`;
	                }
	               }
	          ],
	          "info":false
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NewGP/resources/views/medicineType/index.blade.php ENDPATH**/ ?>