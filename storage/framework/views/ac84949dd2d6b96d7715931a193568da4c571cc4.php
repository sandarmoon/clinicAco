...
<head>
    <meta charset="utf-8">
    <title>jQuery Schedule v2.2.0 Demo</title>
    <meta name="description" content="A schedule management with jQuery.">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css">
    <link rel="stylesheet" href="<?php echo e(asset('template\calendar\jquery.schedule.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template\calendar\jquery.schedule-demo.css')); ?>">
</head>
<body>

<header>
    <nav class="navbar navbar-dark bg-dark mb-3">
        <h1 class="navbar-brand mb-0">jQuery Schedule Demo v2.2.0</h1>
    </nav>
</header>
...
<script src="<?php echo e(asset('template\calendar\jquery.schedule.js')); ?>"></script>
<script>
  $(function () {
    $('#schedule').jqs();
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/gp-clinic/resources/views/schedule/index.blade.php ENDPATH**/ ?>