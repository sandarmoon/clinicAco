	            ...
	            <div class="card-header bg-white border-0">
	              <div class="row align-items-center">
	                <div class="col-8">
		              ...
		              <img src="<?php echo e(asset('template/assets/img/theme/team-4-800x800.jpg')); ?>" width="60" class="rounded-circle float-left d-inline-block mr-4 mt-3">
		                  
	                  <h3 class=" p-0 pr-4 mt-3 ">Mary Brown</h3>
	                   <h6 class="small text-muted mb-4">Clinic Owner</h6>
	                </div>
...
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myprj/my-gp/GP/resources/views/pDetail.blade.php ENDPATH**/ ?>