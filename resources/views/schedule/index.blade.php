...
<head>
    ...
    <link rel="stylesheet" href="{{asset('template\calendar\jquery.schedule.css')}}">
    <link rel="stylesheet" href="{{asset('template\calendar\jquery.schedule-demo.css')}}">
</head>
<body>
...
<script src="{{asset('template\calendar\jquery.schedule.js')}}"></script>
<script>
  $(function () {
    $('#schedule').jqs();
